...
/**
  ...
  * secutiry credentials, and useful shortcut methods.
  */
...
/**
  ...
  * controller only has tot have one thing injected.
  */
...
/**
  * Exposes actions and handler to the PostController by wiring the injected state into base class.
  */
